    ...
    <DefaultPage>
        ...
        <div v-else >
            ...
            <div v-else>
                ...
                <div class="row mb-2" v-if="modulos.art22.length > 0">
                    <div class="col" >
                        <h3>Artículo 22</h3>
                        <div class="list-group shadow-sm mb-4 mt-3">
                            <div class="list-group-item cursorHand" v-for="mod in modulos.art22" :onclick="`javascript:location.href='/transparencia/${mod.id}'`">
                                {{ mod.fraccion }} - {{ mod.titulo }}
                            </div>
                        </div>
                        <hr class="my-2">
